...
<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="<?= base_url() ?>dashboard" class="text-danger font-weight-bold" style="font-size: 16px;"><i class="fas fa-book-open"></i> Catatan Usaha</a>
            <p class="text-danger font-weight-bold mt-n3"><span class="badge badge-danger"> <i class="fas fa-store"></i> <?= $nama ?></span></p>
        </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Catatan Usaha</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                Anda Yakin Keluar Dari Catatan Usaha ?
            </div>
